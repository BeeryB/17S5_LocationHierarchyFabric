define(["require", "exports", "tslib", "react", "../../Utilities", "./ResizeGroup.scss"], function (require, exports, tslib_1, React, Utilities_1, styles) {
    ...
    var ResizeGroup = /** @class */ (function (_super) {
        ...
        ResizeGroup.prototype.render = function () {
            var _a = this.props, onRenderData = _a.onRenderData, className = _a.className;
            var _b = this.state, dataToMeasure = _b.dataToMeasure, renderedData = _b.renderedData;
            return (React.createElement("div", { className: Utilities_1.css('ms-ResizeGroup', className), ref: this._resolveRef('_root') },
