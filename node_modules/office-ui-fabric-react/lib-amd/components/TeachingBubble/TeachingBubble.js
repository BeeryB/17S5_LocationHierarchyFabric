define(["require", "exports", "tslib", "react", "../../Utilities", "./TeachingBubbleContent", "../../Callout", "./TeachingBubble.scss"], function (require, exports, tslib_1, React, Utilities_1, TeachingBubbleContent_1, Callout_1, stylesImport) {
    ...
    var TeachingBubble = /** @class */ (function (_super) {
        ...
        TeachingBubble.prototype.render = function () {
            ...
            return (React.createElement(Callout_1.Callout, tslib_1.__assign({ className: Utilities_1.css('ms-TeachingBubble', styles.root, this.props.isWide ? styles.wideCallout : null), ref: this._resolveRef('_callout'), target: targetElement }, calloutProps),
