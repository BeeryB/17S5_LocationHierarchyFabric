define(["require", "exports", "tslib", "react", "../../Utilities", "./DialogContent.types", "../../Button", "./DialogFooter", "../../utilities/decorators/withResponsiveMode", "./Dialog.scss"], function (require, exports, tslib_1, React, Utilities_1, DialogContent_types_1, Button_1, DialogFooter_1, withResponsiveMode_1, stylesImport) {
    "use strict";
    ...
    var DialogContent = /** @class */ (function (_super) {
        ...
        DialogContent.prototype.render = function () {
            ...
            var contentClassName = Utilities_1.css(this.props.className, (_b = {},
                _b['ms-Dialog--lgHeader ' + styles.isLargeHeader] = type === DialogContent_types_1.DialogType.largeHeader,
                _b['ms-Dialog--close ' + styles.isClose] = type === DialogContent_types_1.DialogType.close,
                _b));
