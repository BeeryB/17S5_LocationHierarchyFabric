    ...
    var HoverCardPage = /** @class */ (function (_super) {
        ...
        HoverCardPage.prototype.render = function () {
            return (React.createElement(example_app_base_1.ComponentPage, { title: 'HoverCard', componentName: 'HoverCardExample', exampleCards: React.createElement(Layer_1.LayerHost, null,
                    ...
                    React.createElement("p", null, "HoverCards supplement content associated with a specific data element.")), componentStatus: React.createElement(ComponentStatus_1.ComponentStatus, tslib_1.__assign({}, HoverCard_checklist_1.HoverCardStatus)), isHeaderVisible: this.props.isHeaderVisible }));
        };
