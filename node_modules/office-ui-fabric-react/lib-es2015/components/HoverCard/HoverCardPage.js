...
var HoverCardPage = /** @class */ (function (_super) {
    ...
    HoverCardPage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'HoverCard', componentName: 'HoverCardExample', exampleCards: React.createElement(LayerHost, null,
                ...
                React.createElement("p", null, "HoverCards supplement content associated with a specific data element.")), componentStatus: React.createElement(ComponentStatus, tslib_1.__assign({}, HoverCardStatus)), isHeaderVisible: this.props.isHeaderVisible }));
    };
