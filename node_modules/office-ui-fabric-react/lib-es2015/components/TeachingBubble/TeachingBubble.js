...
var TeachingBubble = /** @class */ (function (_super) {
    ...
    TeachingBubble.prototype.render = function () {
        ...
        return (React.createElement(Callout, tslib_1.__assign({ className: css('ms-TeachingBubble', styles.root, this.props.isWide ? styles.wideCallout : null), ref: this._resolveRef('_callout'), target: targetElement }, calloutProps),
