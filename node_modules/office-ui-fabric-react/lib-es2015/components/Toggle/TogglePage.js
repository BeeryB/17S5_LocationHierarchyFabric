...
var TogglePage = /** @class */ (function (_super) {
    ...
    TogglePage.prototype.render = function () {
        return (React.createElement(ComponentPage, { title: 'Toggle', componentName: 'ToggleExample', exampleCards: React.createElement("div", null,
                ...
                React.createElement(ExampleCard, { title: 'Toggle with specialized aria labels for the screen-reader to announce when the toggle is on and off', code: ToggleAriaLabelExampleCode },
                    React.createElement(ToggleAriaLabelExample, null))), propertiesTables: React.createElement(PropertiesTableSet, { sources: [
