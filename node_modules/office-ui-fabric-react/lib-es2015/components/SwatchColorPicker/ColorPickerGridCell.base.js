...
import { autobind, customizable } from '../../Utilities';
...
var ColorPickerGridCellBase = /** @class */ (function (_super) {
   ...
   */
    ColorPickerGridCellBase.prototype._onRenderColorOption = function (colorOption) {
        ...
        return (React.createElement("svg", { className: this._classNames.svg, viewBox: '0 0 20 20', fill: getColorFromString(colorOption.color).str }, this.props.circle ?
