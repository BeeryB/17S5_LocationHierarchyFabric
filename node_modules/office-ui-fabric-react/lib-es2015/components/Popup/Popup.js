...
var Popup = /** @class */ (function (_super) {
    ...
    Popup.prototype.render = function () {
        ...
        return (React.createElement("div", tslib_1.__assign({ ref: 'root' }, getNativeProps(this.props, divProperties), { className: className, role: role, "aria-label": ariaLabel, "aria-labelledby": ariaLabelledBy, "aria-describedby": ariaDescribedBy, onKeyDown: this._onKeyDown, style: tslib_1.__assign({}, style, { overflowY: needsVerticalScrollBar ? 'scroll' : 'auto' }) }), this.props.children));
    };
