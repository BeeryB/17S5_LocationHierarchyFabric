...
var TeachingBubblePage = /** @class */ (function (_super) {
    ...
    TeachingBubblePage.prototype.render = function () {
        return (React.createElement(example_app_base_1.ComponentPage, { title: 'TeachingBubble', componentName: 'TeachingBubbleExample', exampleCards: React.createElement(Layer_1.LayerHost, null,
                ...
                React.createElement("p", null, "TeachingBubbles allow the user to display important hints on their web pages with a callout box.")), isHeaderVisible: this.props.isHeaderVisible, componentStatus: React.createElement(ComponentStatus_1.ComponentStatus, tslib_1.__assign({}, TeachingBubble_checklist_1.TeachingBubbleStatus)) }));
    };
